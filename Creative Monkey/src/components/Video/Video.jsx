...
const Video = () => {
  return (
    <div className="h-screen w-full border-t-4 border-purple-400 relative">
      <video
        className="-z-10 min-h-screen absolute top-10  w-full object-cover "
        autoPlay
        loop
        muted
      >
      ...
      <div className="absolute h-full w-full top-0 flex flex-col justify-center items-center ">
        ...
        <span className=" text-white font-quickSand font-bold text-[2.7rem] md:text-[3.5rem] lg:text-[4rem] text-shadow shadow-purple-900">
          <Typewriter
            words={["Creative Monkey", "Confianza", "Experiencia"]}
            loop={true}
            cursor
            cursorStyle="."
            typeSpeed={100}
