...
const NavBar = () => {
    ...
    <ul className="mb-4 mt-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      {links.map((link, i) => (
        <a
          href={link.path}
          key={i}
          className=" font-nunito text-gray-50 text-2xl px-3 py-4 font-medium  hover:font-semibold"
        >
          {link.title}
        </a>
      ))}
  ...
  return (
    <>
      <Navbar className="sticky top-0 z-10 h-max max-w-full rounded-none border-none py-2 px-4 lg:px-8 lg:py-4 bg-transparent">
