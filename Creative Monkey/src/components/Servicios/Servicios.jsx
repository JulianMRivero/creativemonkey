...
const Servicios = () => {
  const servicios = [
    ...
    },
    {
      ...
      description: "Producciones Fotograficas (Interior / Exterior)",
    },
    {
      id: 3,
      svg: streaming,
      description: "Streaming en vivo o falso vivo",
    },
    {
      id: 4,
      svg: event,
    ...
    },
    {
      id: 6,
      svg: programing,
      description: "Diseño Grafico y Web",
    },
    {
      id: 7,
      svg: asesoria,
    ...
    },
    {
      id: 8,
      svg: alquier,
      description: "Alquiler de equipos para producciones Audiovisuales.",
    },
  ];
  return (
    <div className="min-h-screen  bg-gradient-to-b from-gray-50 to-purple-100">
      <div className="flex justify-center items-center">
        <h2 className=" font-semibold  text-black text-5xl md:text-7xl mt-12">
          Servicios
        </h2>
      </div>
      <div className="flex justify-center items-center flex-col w-full mt-10 gap-10  lg:flex-col">
        {servicios.map((servicio) => {
          return (
            ...
            >
              <h2 className=" font-medium  text-black ml-5 text-xl md:text-4xl text-center">
